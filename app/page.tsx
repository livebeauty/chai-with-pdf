         ...
         <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
           <div className="flex flex-col justify-center items-center max-w-7xl mx-auto px-6 lg:px-8">
             <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="text-base font-semibold leading-7 text-orange-600">Your Interactive Document Companion</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Transform your PDFs into Interactive Conversations
               </p>

              <p className="mt-4 text-lg leading-8 text-gray-600">Introducing {" "}
              <span className="font-bold text-orange-600">Chat with PDF</span>
              <br/>
              <br/>Upload your document, and our chatbot with answer questions, summarize content, and
              answer all your questions. Ideal for everyone, 
              <span>Chat with PDF</span> {" "}turn static documents into {" "}
